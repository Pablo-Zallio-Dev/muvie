      ...
      return (
            ...
            <section className=" flex flex-col justify-between gap-2 w-32.5 md:w-55 shadow-xl/10 shadow-slate-400 "  >
                  ...
                  <section className=" relative w-full overflow-hidden ">
                        <img src={movie.posterUrl} alt={`Imagen de la pelicula ${movie.title}`} className=" w-32 md:w-55 object-contain aspect-2/3 lg:hover:scale-105 transition-transform duration-200  " loading="lazy" />
